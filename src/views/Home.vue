    ...
    <div class="ed" :class="{ show: store.emergencyOpen }" v-show="store.emergencyOpen">
      ...
      <div class="ed_content">
        ...
        <div class="ed_content_info">
          ...
          <div class="ed_content_info_log _font_1">EN 80%  HI 50%  PSI 30%  CQL 50%
SHIP: GRAND-STARRS-RAY
STATUS: STANDBY
AUTH: GRANTED</div>
          <div class="ed_content_info_button _font_1" @click="store.emergencyOpen=false">执行已授权操作</div>
        </div>
      </div>
    </div>
    ...
    <div class="ad" :class="{ show: store.adOpen && !store.systemOpen && !store.instructionOpen && !store.menuOpen }" v-show="store.adOpen && !store.systemOpen && !store.instructionOpen && !store.menuOpen">
      <div class="ad_title">
        ...
        <div class="ad_title_button" @click="store.adOpen=false"></div>
      </div>
      ...
      <div class="ad_line" style="--l:0.4"></div>
    </div>
  </div>
</template>
